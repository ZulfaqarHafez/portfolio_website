        ...
        <div className="relative z-20 h-full flex flex-col">
          ...
          <div className="p-3 flex flex-col flex-grow">
            ...
            <div className="flex gap-2 mb-2">
              <span className="px-2 py-0.5 bg-accent/20 text-accent text-[10px] font-semibold rounded-full border border-accent/30 card-chip-readable">
                {project.role}
              </span>
              <span className="px-2 py-0.5 bg-luxury-charcoal text-neutral-300 text-[10px] font-medium rounded-full border border-accent/10 card-chip-readable">
                {project.teamSize}
              </span>
            </div>
            <h3 className="card-title-readable text-base md:text-lg font-bold font-serif text-luxury-cream mb-1.5 group-hover:text-accent transition-colors duration-300">
              {project.title}
            </h3>
            <p className="card-text-readable card-muted-readable mb-3 text-xs flex-grow">
              {project.description}
            </p>
            ...
            <div className="flex flex-wrap gap-1.5 mb-3">
              {project.technologies.map((tech, techIdx) => (
                <span
                  key={techIdx}
                  className="px-1.5 py-0.5 bg-luxury-charcoal text-neutral-300 text-xs font-medium rounded-md border border-accent/10 group-hover:border-accent/30 transition-colors card-chip-readable"
                >
                  {tech}
                </span>
              ))}
            ...
            <div className="flex gap-2.5 mt-auto pt-2.5 border-t border-accent/10">
              <a
                ...
                className="flex items-center gap-2 card-subtle-readable hover:text-accent transition-colors text-sm font-semibold group/link"
              >
